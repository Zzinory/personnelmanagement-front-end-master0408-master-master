    ...
    <el-dialog title="修改信息" :visible.sync="dialogFormVisible">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="closeCard">确定</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
  </div>
...
export default {
  data() {
    return {
      ...
      // imgUrl: 'https://gw.alipayobjects.com/zos/rmsportal/BiazfanxmamNRoxxVxka.png',
      imgUrl: require('../../img/imgUrl1.jpg'),
      form: {
        id: "1",
        userName: "测试",
        userAccount: "123",
  ...
  created() {
    ...
    let id={id:this.$store.state.userId};

    getUserById(id).then(resp=>{
      // console.log(resp);
      this.form=resp.data.data;
      if (resp.data.data.role==2)
        this.form.position="员工";
      else
        this.form.position="人事管理";
